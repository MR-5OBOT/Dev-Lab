...
\noindent \( \rightrightarrows \) \hspace{0.1cm}LTP : | [ Daily ERL to IRL ] 
  ...
  \begin{center}
    % \includegraphics[scale=0.3]{./figures/NQ1!_2024-03-07_NQ_daly.png}
  \end{center}
\end{notebox}
...
\begin{notebox}
  ...
  \begin{center}
    % \includegraphics[scale=0.3]{./figures/NQ1!_2024-03-07_1H.png}
  \end{center}
\end{notebox}
\end{figure}
...
\begin{notebox}
  \( \rightrightarrows \) \hspace{0.1cm}STP : | [ 5M Excution | Breakeven ]
   \begin{center}
    % \includegraphics[scale=0.35]{./figures/NQ1!_2024-03-07_5M_entry.png}
  \end{center}
\end{notebox}
\end{figure}
